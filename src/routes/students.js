...
// A bad row (missing field, invalid house, a stray header row
// accidentally pasted into the middle of the data, etc.) is SKIPPED and
// reported — it does not abort the rest of the batch. Duplicate
// member_ids (already in the database) are reported separately, not
